    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: start;" class="product-layout">
      ...
      <div style="padding-bottom: 40px;">
        ...
        <div class="purchase-options" style="margin-bottom: 32px;" id="purchase-options-container">
          ...
          <!-- Option 2: 7-Day Pack -->
          <label class="po-card" onclick="updatePrice(7, 3483, 10, this)">
            <div class="po-header">
              <div style="display: flex; align-items: center; gap: 12px;">
          ...
          <label class="po-card" onclick="updatePrice(30, 14945, 25, this)">
            <div class="po-header">
              <div style="display: flex; align-items: center; gap: 12px;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: start;" class="product-layout">
      ...
      <div style="padding-bottom: 40px;">
        ...
        <div class="purchase-options" style="margin-bottom: 32px;" id="purchase-options-container">
          ...
          <!-- Option 2: 7-Day Pack -->
          <label class="po-card" onclick="updatePrice(7, 1033, 10, this)">
            <div class="po-header">
              <div style="display: flex; align-items: center; gap: 12px;">
                <input type="radio" name="purchase_option" class="po-radio" value="7day">
                7-Day Starter Pack
          ...
          <!-- Option 3: 30-Day Pack -->
          <label class="po-card" onclick="updatePrice(30, 4445, 25, this)">
            <div class="po-header">
              <div style="display: flex; align-items: center; gap: 12px;">
                <input type="radio" name="purchase_option" class="po-radio" value="30day">
                30-Day Monthly Pack <span style="background:#1A1A1A;color:#fff;font-size:10px;padding:2px 6px;border-radius:4px;margin-left:8px;font-weight:600;display:inline-block;">Most Popular</span>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: start;" class="product-layout">
      ...
      <div style="padding-bottom: 40px;">
        ...
        <div class="purchase-options" style="margin-bottom: 32px;" id="purchase-options-container">
          ...
          <!-- Option 2: 7-Day Pack -->
          <label class="po-card" onclick="updatePrice(7, 2783, 10, this)">
            <div class="po-header">
              <div style="display: flex; align-items: center; gap: 12px;">
                <input type="radio" name="purchase_option" class="po-radio" value="7day">
                7-Day Starter Pack
          ...
          <!-- Option 3: 30-Day Pack -->
          <label class="po-card" onclick="updatePrice(30, 11945, 25, this)">
            <div class="po-header">
              <div style="display: flex; align-items: center; gap: 12px;">
                <input type="radio" name="purchase_option" class="po-radio" value="30day">
                30-Day Monthly Pack <span style="background:#1A1A1A;color:#fff;font-size:10px;padding:2px 6px;border-radius:4px;margin-left:8px;font-weight:600;display:inline-block;">Most Popular</span>
